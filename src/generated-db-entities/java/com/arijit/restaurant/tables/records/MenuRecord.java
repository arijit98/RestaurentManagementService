...
public class MenuRecord extends TableRecordImpl<MenuRecord> implements Record7<UUID, String, String, Double, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row7<UUID, String, String, Double, String, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public MenuRecord values(UUID value1, String value2, String value3, Double value4, String value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public MenuRecord(UUID id, String itemName, String status, Double price, String description, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Menu.MENU);
